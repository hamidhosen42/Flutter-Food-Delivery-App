...
class PopularItemPage extends StatefulWidget {
  final String name;
  final int rating;
  final int price;
  ...
  @override
  State<PopularItemPage> createState() => _PopularItemPageState();
}

class _PopularItemPageState extends State<PopularItemPage> {
  int? quantity = 1;
  int? total = 0;
